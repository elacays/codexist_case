...
export default function BookDetails() {
  return (
    <div className=" text-black mt-16 bg-white rounded-lg shadow-2xl">
      <div className="container px-5  mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap justify-center align-middle">
          <img
            alt="ecommerce"
            className="lg:w-1/2 w-full object-cover object-center rounded-lg shadow-lg"
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 flex flex-col align-middle justify-center">
            ...
            <div className="flex">
              ...
              <button className="flex ms-4  border-0 py-2 px-6 focus:outline-none bg-pink-500 rounded">
                <a className=" flex items-center" href="#">
                  ...
                  <p className="ms-2 text-white">Buy</p>
                </a>
              </button>
            </div>
          </div>
